...
export default function Contact() {
  return (
    <section id="contact" className="text-center bg-white text-dark py-5 px-3">
      <div className="container">
        <h2 className="mb-4 fw-bold" data-aos="fade-up">Get In Touch</h2>
        <p className="lead text-secondary mb-4">
          Need a repair or have a question? Reach out below.
        </p>
        <a href="mailto:info@bytefix.com" className="btn btn-dark btn-lg mb-5">
          Email Us
        </a>

        <div className="ratio ratio-16x9 rounded overflow-hidden shadow-sm" style={{ maxWidth: '100%' }}>
          <iframe
